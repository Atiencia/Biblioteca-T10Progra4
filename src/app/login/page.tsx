      ...
      <div className="w-full max-w-md bg-white rounded-lg shadow-lg p-8 border border-gray-100">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <input
            ...
            required
          />
          <button type="submit" className="w-full py-2 mt-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded transition-colors shadow">Entrar</button>
        </form>
